...
object CommunicationContextFactory {
    ...
    fun buildCommunicationContext(device: DeviceInfoDto, appVersion: AppVersion): CommunicationContextI =
    ...
    fun buildCommunicationContext(
        ...
        vararg files: File
    ): FileCommunicationContextI =
        object : FileCommunicationContextI {
    ...
    fun buildCommunicationContext(
        device: DeviceInfoDto,
        stringData: String
    ): ClipboardCommunicationContextI =
        object : ClipboardCommunicationContextI {
