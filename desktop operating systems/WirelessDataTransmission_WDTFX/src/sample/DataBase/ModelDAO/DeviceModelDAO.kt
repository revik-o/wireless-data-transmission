...
class DeviceModelDAO(iDataBase: IDataBase): IDAO {
    ...
    init {
        ...
        iDataBase.executeQuery(FeedReaderContract.SQL_CREATE_DEVICE)
    }
    ...
    override fun selectAllWithRowId(): ArrayList<Array<String>> = iDataBase.executeRowQuery(
            "SELECT keyid, ${deviceTable.ID}, ${deviceTable.DEVICE_NAME}, ${deviceTable.DEVICE_TYPE}, ${deviceTable.IP_ADDRESS} FROM ${deviceTable.TABLE_NAME};"
    )
